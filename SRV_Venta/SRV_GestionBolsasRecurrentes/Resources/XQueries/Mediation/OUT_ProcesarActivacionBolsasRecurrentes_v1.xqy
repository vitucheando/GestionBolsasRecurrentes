...
declare namespace ns2="http://entel.com.pe/GestionBolsasRecurrentes_ProcesarActivacionBolsasRecurrentesRequest_response";
(:: import schema at "../../XSD/Messages/ProcesarActivacionBolsasRecurrentesResponse_v1.xsd" ::)
...
declare function local:func($idTransaccionESB as xs:long, 
                            ...
                            as element() (:: schema-element(ns2:procesarActivacionBolsasRecurrentesResponse) ::) {
    <ns2:procesarActivacionBolsasRecurrentesResponse>
        <ns2:header>

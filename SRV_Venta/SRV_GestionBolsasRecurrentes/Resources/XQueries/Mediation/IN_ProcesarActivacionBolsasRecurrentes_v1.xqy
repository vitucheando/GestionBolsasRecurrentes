...
declare namespace ns1="http://entel.com.pe/GestionBolsasRecurrentes_ProcesarActivacionBolsasRecurrentesRequest_request";
(:: import schema at "../../XSD/Messages/ProcesarActivacionBolsasRecurrentesRequest_v1.xsd" ::)
...
declare variable $requestBody as element() (:: schema-element(ns1:procesarActivacionBolsasRecurrentesRequest) ::) external;

declare function local:func($requestBody as element() (:: schema-element(ns1:procesarActivacionBolsasRecurrentesRequest) ::)) as element() (:: schema-element(ns2:gestionBolsasRecurrentesRequest) ::) {
